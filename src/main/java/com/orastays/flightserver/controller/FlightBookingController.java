...
public class FlightBookingController extends BaseController {
	...
	public ResponseEntity<ResponseModel> bookFlights(@RequestBody BookingModel bookingModel) {

		logger.info("book-flights -- START");

		ResponseModel responseModel = new ResponseModel();
		Util.printLog(bookingModel, FlightConstant.INCOMING, "Book Flights", request);
		try {
			PaymentModel paymentModel = bookingService.bookFlights(bookingModel);
